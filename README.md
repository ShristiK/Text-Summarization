...
The presence of connectedness makes the summary coherent and logical; without which the summary appears to have jumps between consecutive sentences and becomes more difficult to understand. The idea of using domination helps in removing the need of scoring the sentences and the presence of connectedness makes the summary coherent.
